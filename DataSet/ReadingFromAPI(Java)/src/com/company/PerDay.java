...
public class PerDay {
    ...
    public int get_response(String apiKey,String location, String startDay,String endDay, int days,int year,int month,BufferedWriter bw){
        String text="";
        try {
            String url = "http://api.worldweatheronline.com/premium/v1/past-weather.ashx?key="+apiKey+"&q="+location+"&tp=24&date="+startDay+"&enddate="+endDay;
